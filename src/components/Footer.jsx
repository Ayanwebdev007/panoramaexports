...
import { Mail, ArrowUp, Youtube, Twitter, Linkedin, ChevronRight } from "lucide-react";
        ...
        <footer className="bg-[#01276a] text-white font-outfit">
            ...
            <div className="flex flex-col lg:flex-row border-b border-white/10">
                ...
                <div className="lg:w-[30%] p-8 md:p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-center">
                    ...
                    <p className="text-[#b89d6d] font-medium leading-relaxed text-lg md:text-xl max-w-md italic">
                        Where Heritage Meets Modern Luxury
                    </p>
                </div>

                {/* Module 2: Social Tabs (Vertical Stack) - Narrower Section */}
                ...
                {/* Module 3: Reach Us (Large Display) */}
                <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center relative overflow-hidden bg-white/5">
                    ...
                    <div className="mt-12 lg:mt-0 select-none">
                        <h1 className="text-5xl md:text-6xl lg:text-[clamp(3.5rem,8.5vw,7.5rem)] font-bold tracking-tighter text-white leading-none opacity-90 transition-transform duration-500 hover:scale-[1.02] cursor-default whitespace-nowrap">
                            REACH US
                        </h1>
                    </div>
                </div>
            ...
            <div className="px-8 md:px-12 lg:px-16 py-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="text-xs md:text-sm text-gray-400 space-y-1">
                        <p>© 2024 – 2025 | All rights reserved by Panorama Exports Pvt Ltd</p>
                        <p className="opacity-60">Developed by codeworks</p>
                    </div>
