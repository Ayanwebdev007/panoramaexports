            ...
            >
                ...
                <div className={`relative z-10 w-full h-full flex ${item.alignItems || "items-center"} ${item.justifyContent || (index % 2 === 0 ? "justify-start" : "justify-end")} ${item.containerPadding || "px-[5%] md:px-[10%]"}`}>
                    <motion.div 
                        ...
                        className="bg-[#011627]/50 backdrop-blur-md p-6 md:p-8 lg:p-10 max-w-md text-white shadow-2xl relative overflow-hidden group/box"
                    >
                        {/* Decorative accent line */}
                        <div className={`absolute top-0 ${index % 2 === 0 ? "left-0" : "right-0"} w-1.5 h-full bg-blue-400 opacity-50`} />
                        ...
                        <div className={`absolute bottom-4 ${index % 2 === 0 ? "right-6" : "left-6"} text-white/20 font-outfit text-[10px] tracking-[0.2em]`}>
