        ...
        <>
            <div className="font-outfit">
                ...
                >
                    {peopleImages.map((pImg, i) => {
                        ...
                        if (i === index) {
                            ...
                            classNames +=
                                " shadow-2xl border-[8px] border-[#AD1E1E]";
                ...
                <div className="lg:w-[60%] mx-auto 2xl:mt-36 mt-28 2xl:mb-20 mb-14 ">
                    <h1 className="lg:text-4xl md:text-3xl text-2xl font-light text-[#AD1E1E] mb-5 font-outfit text-center">
                        People-Progress-Purpose
                    </h1>
                    <div className="lg:text-xl leading-loose text-justify font-light">
